...
cakes = Cake.create([{name: "Banana Cake", weight: 1, flavor: "Banana", ingredients: "mashed bananas, ground cinnamon, eggs, vanilla extract, sugar, baking powder, baking soda, all-purpose flour"}])
cakes = Cake.create([{name: "Mangese Cake", weight: 2, flavor: "Mango", ingredients: "blended mangos, eggs, vanilla extract, baking powder, sugar, baking soda, all-purpose flour"}])
cakes = Cake.create([{name: "Mr.Berry Cake", weight: 5, flavor: "Strawberry", ingredients: "blended strawberries, berry cream, whipped cream, eggs, vanilla extract, baking powder, baking soda, flour"}])
cakes = Cake.create([{name: "Caramel Cake", weight: 5, flavor: "Caramel", ingredients: "white sugar, butter, eggs, all-purpose flour, baking powder, salt, milk, vanilla extract"}])
cakes = Cake.create([{name: "Chocolate Cake", weight: 5, flavor: "Chocolate", ingredients: "all-purpose flour, sugar, cocoa powder, baking powder, baking soda, espresso powder, buttermilk, almond milk, oat milk, coconut milk, coconut oil, eggs, vanilla extract"}])
